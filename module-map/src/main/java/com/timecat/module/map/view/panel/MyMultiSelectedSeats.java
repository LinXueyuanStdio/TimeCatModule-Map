 ...
 * 选中座位控制器强化, 增加对底部栏的刷新
 */
public class MyMultiSelectedSeats extends MultiSelectedSeats {
    public MyMultiSelectedSeats(MapView seatSelectionView, int maxSeatNum) {
...
//
//    public MyMultiSelectedSeats(MapView seatSelectionView, AuditoriumInfo auditoriumInfo,
...
//            Seat seat = getSeat(i);
//            selectedItemTextViews.get(i).setText(seat.title());
